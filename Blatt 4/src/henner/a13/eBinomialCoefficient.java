 ...
 *
 */
public class eBinomialCoefficient {
  ...
  //Attribute
	...
	*/
	public eBinomialCoefficient(int n, int k) throws IllegalArgumentException{
    ...
    */
    public eBinomialCoefficient() throws IllegalArgumentException {
    	this(0, 0);
    }
     ...
     *  @throws IllegalArgumentException falls n und/oder k falsch gewaehlt sind
     */
    public eBinomialCoefficient(BinomialCoefficient koeffizient) throws IllegalArgumentException {
    	this(koeffizient.getN(), koeffizient.getK());
    }
